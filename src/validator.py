...
class Validator:
    ...
    Выбираются ключи:
    'name', 'salary' (Внутри содержит вложенный словарь {'from' и 'to'}, разделяется на ключи 'salary_from' и \
    ...
    def validate(vacancy_params: dict) -> dict:
        ...
        """
        __required_keys = ('name', 'salary', 'published_at', 'archived', 'apply_alternate_url', 'snippet')
...
if __name__ == "__main__":
    ...
    for item in reformated_vacancies:
        print(item)
